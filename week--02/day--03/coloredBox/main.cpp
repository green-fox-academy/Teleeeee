...
void draw()
{
    ...
    SDL_SetRenderDrawColor(gRenderer, 0x45 /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0x45 /*A*/);
    SDL_RenderDrawLine(gRenderer, 255, 210, 255, 270);

    SDL_SetRenderDrawColor(gRenderer, 0x78 /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0x92 /*A*/);
    SDL_RenderDrawLine(gRenderer, 375, 210, 375, 270);

    SDL_SetRenderDrawColor(gRenderer, 0xcc /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0xaa /*A*/);
    SDL_RenderDrawLine(gRenderer, 255, 210, 375, 210);

    SDL_SetRenderDrawColor(gRenderer, 0xdd /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0x23 /*A*/);
